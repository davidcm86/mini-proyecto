...
<?php echo $this->Form->create('InstalacionesDeportiva'); ?>
	<fieldset>
		<legend><?php echo __('Edit Instalaciones Deportiva'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('InstalacionesDeportiva.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('InstalacionesDeportiva.id'))); ?></li>
